      ...
      link={
        <>
          <MainMenuItemClientLink
            ...
            href={url || "#"}
            className={twMerge(
              "hocus:text-white hocus-visible:border-white hocus-visible:underline lg:text-digital-red lg:hocus:text-black col-start-1 col-end-9 border-l-[6px] border-transparent py-5 text-white no-underline transition-all",
              clsx({
          ...
          {level === 0 && <span className="bg-archway-light mb-6 ml-5 hidden h-25 w-1 lg:block" />}
        </>
      }
    >
      {children.length > 0 && (
