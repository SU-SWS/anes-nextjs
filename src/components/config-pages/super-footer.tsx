...
const SuperFooter = async ({...props}: Props) => {
  ...
  return (
    <div {...props} className={twMerge("border-black-20 bg-foggy-light border-b py-20", props.className)}>
          ...
          <div className="inline-block">
                ...
                {superFooterConfig.suSuperFootLink.map((link, index) => {
                  ...
                  return (
                    <Link
                      ...
                      href={link.url}
                      className="border-black-20 text-digital-red hocus:bg-black hocus:text-white hocus:underline mb-5 block border bg-white p-10 no-underline shadow-lg transition last:mb-0"
                    >
                      {link.title}
                    </Link>
                  )
            ...
            {superFooterConfig.suSuperFootIntranet?.url && (
              <Link
                ...
                className="text-digital-red hocus:text-black hocus:underline flex items-center no-underline"
              >
