...
const PageFooter = ({...props}: Props) => {
  return (
    <footer {...props}>
      ...
      <div className="bg-black py-50 [&_a]:text-white [&_a]:no-underline [&_a:hocus]:text-white">
        <div className="centered lg:flex lg:items-center lg:gap-20">
          <div className="mb-10 text-center">
            <a className="logo type-3 hocus:text-white text-white" href="https://www.stanford.edu">
              Stanford
              <br />
              University
            </a>
