...
export const NewsListSkeleton = () => {
  return (
    <div>
      <div className="border-black-20 flex min-h-[200px] items-center justify-between border-b pb-10">
        <div className="flex-grow">
          <div className="bg-black-10 mb-5 h-7 w-1/3" />
          <div className="bg-black-10 mb-10 h-16 w-1/2" />
          <div className="bg-black-10 mb-5 h-7 w-1/3" />
        </div>
        <div className="bg-black-10 relative order-1 mb-10 aspect-[16/9] shrink-0 @3xl:order-2 @3xl:mb-0 @3xl:w-1/4" />
      </div>
